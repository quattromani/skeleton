...
<div class="box-column clear">
  ...
  <a href="" class="btn btn-primary mobile-full">.btn.btn-primary</a>

  <a href="" class="btn btn-primary js-disabled mobile-full">.btn.btn-primary.js-disabled</a>
...
&lt;button class="btn disabled mobile-full" type="button"&gt;button&lt;/button&gt;
</pre>
</div>
